(function () {
    ...
    DXDemo.focusMainElement = function () {
        ...
        if (mainElement) {
            var childElement = ASPx.FindChildActionElement(mainElement, function (el) {
    ...
    var DXUploadedFilesContainer = {
        ...
        AddFile: function (fileName, fileType, fileSize) {
            ...
            builder.push(">");
            self.BuildLink(builder, fileName, "/#");
            builder.push("</td>");
