<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportList.aspx.cs" Inherits="HealthAPP.ReportList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:RadioButtonList ID="rb_Type" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetByStatusMaker"
        TypeName="HealthAPP.BLL.ReportData" DataObjectTypeName="HealthAPP.BLL.ReportData">
        <SelectParameters>
            <asp:SessionParameter SessionField="emp" Name="maker" Type="Int32" />
             <asp:ControlParameter ControlID="rb_Type" Name="status" Type="Byte" />
        </SelectParameters>
